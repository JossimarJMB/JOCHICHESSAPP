...
class Pareo2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pareo2)
        ...
        tv1x.text = "Ronda 2 de $nRondas, del torneo $nTorneo con $nPar Participantes"
        ...
        b1.setOnClickListener() {
            ...
            if(cRadio == fRadio){
                ...
                var intent = Intent(this, Pareo3::class.java)
