...
class Pareo4 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pareo4)
        ...
        tv1x.text = "Ronda 4 de $nRondas, del torneo $nTorneo con $nPar Participantes"
        ...
        b1.setOnClickListener() {
            ...
            if(cRadio == fRadio){
                ...
                var intent = Intent(this, Pareo5::class.java)
