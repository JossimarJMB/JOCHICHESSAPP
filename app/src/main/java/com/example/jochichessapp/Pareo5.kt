...
class Pareo5 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_pareo5)
        ...
        tv1x.text = "Ronda 5 de $nRondas, del torneo $nTorneo con $nPar Participantes"
        ...
        b1.setOnClickListener() {
            ...
            if(cRadio == fRadio){
                ...
                //Como lo máximo son 5 rondas, se envía directo a los resultados.
